...
import 'package:chat/common/utils/date.dart';
...
class MessageList extends GetView<MessageController> {
  ...
  Widget messageListItem(QueryDocumentSnapshot<Msg>item,context){
    return Container(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          item.data().from_uid==controller.token?item.data().to_name!:item.data().from_name!,
